...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:R0cks0l!d-drupal@localhost/drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civi:R0cks0l!d-civi@localhost/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/opt/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/opt/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://drupalbuild.mackereth.id.au/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '025afdc912a1ae8ee85c3e8f10e54354');
}
...
// define( 'CIVICRM_MAIL_LOG', '/opt/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
